...
namespace UniSky
{
    ...
    public sealed partial class App : Application
    {
        ...
        private void ConfigureServices()
        {
            ...
            global::Uno.Extensions.LogExtensionPoint.AmbientLoggerFactory = Ioc.Default.GetRequiredService<ILoggerFactory>();
#if HAS_UNO
        ...
        protected override void OnLaunched(LaunchActivatedEventArgs args)
        {
...
#endif
            {
                if (rootFrame.Content == null)
                {
                    ...
                    // parameter
                    rootFrame.Navigate(typeof(RootPage), args.Arguments);
                }
        ...
        /// </summary>
        private static void InitializeLogging(ILoggingBuilder builder)
        {
#if DEBUG
